<div class="row" id="divTentangAplikasi">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-12">
        <div class="card card-primary">
            <div class="card-header"><h4>Kelompok 7</h4></div>
            <div class="card-body">
            <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      ...
                      <div class="media-body">
                        ...
                        <span class="text-small text-muted">@gmail.com</span>
                      </div>
                    </li>
                    <li class="media">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <p id='divKontributor'>
                    Terima kasih kepada Pak Atta Putra Harjanto yang telah memberikan kami kelompok 7 dalam memberikan bantuan dalam bentuk apapun. Sedikit banyaknya bantuan dari teman teman kelompok lainnya , 
                    dalam memberikan ilmu dan saran lainnya sehingga kami dapat menyelesaikan project tugas sistem informasi akuntansi ini. 
                    <a href=https://akuntansi.unnes.ac.id/' target="_new"><h4>Akuntansi UNNES (2022)</h4></a> 
                </p>
            </div>
        </div>
