                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left py-5 px-4 px-sm-5" id='login-app'>
                                <div class="brand-logo" style='text-align:center;'>
                                    ...
                                    <h4 style="font-weight:bold;">Aplikasi Manajemen Burjo</h4>
                                </div>
                                <div style='text-align:center;'>
                                    <h6 class="font-weight-light">Silahkan login pada form dibawah ini.</h6>
                                    <div>
                                        <div class="pt-3">
                                            ...
                                            <div class="mt-2">
                                                <div style='padding-top:12px;'>
                                                    <h5 class="font-weight-light">2022 &copy; <a href='https://akuntansi.unnes.ac.id/' target='new'>Kelompok 7</a>
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
