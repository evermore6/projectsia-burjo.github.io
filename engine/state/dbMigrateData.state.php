...
class dbMigrateData{
    ...
    public function create_tbl_slider()
    {
        ...
        $this -> st -> queryRun();
        // insert default data 
        $this -> st -> query('INSERT INTO `tbl_slider` VALUES (1,"Welcome to NadhaResto","Best burjo in sekaran","Harga murah, kualitas makanan luar biasa","soto_ayam.jpg","Order now","home/selfservice");');
        $this -> st -> queryRun();
    }
